...
object Constants {
    ...
    const val SERVER_URL = "https://quytech.net/shoparty/public/api/v1/"  // server url
       const val PRIVACYPOLICY = "https://quytech.net/shoparty/public/privacy-policy"
        ...
        const val SUMMERYPRICE = "SUMMERYPRICE"
        const val TOTALAMOUNT = "TOTALAMOUNT"
        const val TOTALTAX = "TOTALTAX"
        const val ORDERTYPE = "ORDERTYPE"
        const val PROMOCODEID = "PROMOCODEID"
        const val DISCOUNTAMOUNT = "DISCOUNTAMOUNT"
        const val ISDELIVERABLE = "ISDELIVERABLE"
        const val STOREID = "STOREID"
        const val SHOPPINGID = "SHOPPINGID"
        const val MALE = "Male"
        ...
        const val PAGESTATUS = "PAGESTATUS"
         ...
         const val INSTAGRAMELINK = "INSTAGRAMELINK"
          ...
          const val TOPSELLINGSUBCATEGORY = "TOPSELLINGSUBCATEGORY"
